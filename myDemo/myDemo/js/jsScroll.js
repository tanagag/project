...
function jsScroll(obj, w, className)
{
	...
	if(!className) {
		...
		obj.scrollBarIndex.style.borderWidth = '1px';
		obj.scrollBarIndex.style.borderColor = '#CCC';
		obj.scrollBarIndex.style.borderStyle = 'solid';
		*/
		obj.scrollBarIndex.className  = 'scrollBarIndex';
	}
	...
	obj.scrollBarIndex.onmousedown = function(evt){
		...
		if(this.scrollDiv.scrollBar.className == '') {
			this.scrollDiv.scrollBarIndex.style.backgroundColor = '#CCC';
		}
		return false;
	}
}
...
document.documentElement.onmouseup = function(evt){
	...
	if(scrollMoveObj.scrollBar.className == '') {
		scrollMoveObj.scrollBarIndex.style.backgroundColor = '#fff';
	}
	scrollMoveObj = null;
